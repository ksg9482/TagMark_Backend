...
import {
  BookmarkUseCases,
  BookmarkFactoryService,
} from 'src/use-cases/bookmark';
import { TagUseCases } from 'src/use-cases/tag';
import { UtilsService } from 'src/utils/utils.service';
import {
  SyncBookmarkDto,
  SyncBookmarkResponseDto,
} from './dtos/bookmark/sync-bookmark.dto';
...
export class BookmarkController {
  ...
  async createBookmark(
    ...
    try {
      const bookmark =
        this.bookmarkFactoryService.createNewBookmark(createBookmarkDto);
  ...
  @Get('/count')
  async getUserBookmarkCount(@AuthUser() userId: number) {
